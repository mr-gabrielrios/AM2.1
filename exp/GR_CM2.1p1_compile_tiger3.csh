...
set executable    = $root/idealized_exec_$platform/$type/fms_$type.x      # executable created after compilation
...
if($static) then
  set executable = $root/idealized_exec_$platform/${type}_static/fms_$type.x 
